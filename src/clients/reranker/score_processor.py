...
# The "document.text" field is present when the original documents list is sent.
# Results are already sorted by relevance_score DESC by the API,
# but we sort explicitly to guarantee ordering regardless of provider.
# """
...
#     """Parses OpenRouter/Cohere rerank API response into (text, score) tuples."""
...
#         """
#         Extract and sort rerank results from the API response.
...
#         Returns:
#             List of (document_text, score) tuples sorted by score DESC.
...
#                     text = doc_obj.get("text") or documents[index]
#                 else:
